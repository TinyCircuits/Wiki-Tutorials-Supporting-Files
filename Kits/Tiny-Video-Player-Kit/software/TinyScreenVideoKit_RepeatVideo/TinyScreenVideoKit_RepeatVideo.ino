...
// Add these variables and functionality if using a Tiny Arcade: 
#if compileForArcade
...
#endif // End Tiny Arcade variable additions
...
// Repeated "loop" of what program is continuously running
void loop() {
  /*
  // Continuously check if buttons are pressed
...
void playVideo() {
  ...
  // int showBar = 50;
  int showBar = 0; // Do not show menu bar as video begins
  int paused = false;
  int showPlaying = 0;
  int debounceX = 10;
  int debounceY = 10;
